//Write Java code to determine the smallest number of three numbers entered by the user. You can take in some numbers as an
// input, and calculate the smallest of them. After doing that, print out the smallest number as:
